...
class RecentReportsTableViewController: UITableViewController {
    ...
    var discriptionContent = ["Graffiti on walls and it is crumpling down.", "Walls wearing down and falling apart", "Boarded windows, bad look.", "trash utside house been there for a while.", "badly kept yard, very over grown.", "Trash outside, giving bad look from street.", "hevily graffitied, boarded up windows.", "Graffiti on walls and it is crumpling down.", "trash utside house been there for a while.", "Boarded windows, bad look from the street, and for the others houses around."]
